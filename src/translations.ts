...
export const translations: Record<Language, Translations> = {
  ...
  ur: {
    instituteName: "الْإِخْلَاص اسلامک انسٹیٹیوٹ",
    ...
    home: {
      ...
      heroSubtext: "الْإِخْلَاص اسلامک انسٹیٹیوٹ لاہور میں خوش آمدید — ایک ایسا ادارہ جو اسلامی تعلیمات کو سیکھنے، سمجھنے اور ان پر عمل کرنے کے لیے وقف ہے۔",
      ...
      learningText1: "چاہے آپ بنیادی اسلامی فہم حاصل کرنا چاہتے ہوں یا اپنی روحانی زندگی کو نکھارنا چاہتے ہوں، لاہور میں تعلیمی مواقع کے لیے الْإِخْلَاص اسلامک انسٹیٹیوٹ سے ضرور رابطہ فرمائیں۔",
      ...
      ctaSubtext: "کیا آپ کے پاس الْإِخْلَاص اسلامک انسٹیٹیوٹ کے تعلیمی مواقع سے متعلق کوئی سوالات ہیں؟ آج ہی آن لائن داخلہ فارم پُر کیجیے یا ہم سے رابطہ کیجیے۔",
    ...
    about: {
      ...
      pageTitle: "الْإِخْلَاص اسلامک انسٹیٹیوٹ کے بارے میں",
      ...
      purposeText1: "الْإِخْلَاص اسلامک انسٹیٹیوٹ کا قیام لاہور، پاکستان میں اس مقصد کے تحت عمل میں آیا کہ یہ اسلامی تعلیم اور ذاتی تربیت کا ایک روشن ذریعہ بنے۔ ہمارا پختہ یقین ہے کہ حقیقی اسلامی تعلیم انسان کی عقل اور دل دونوں کو منور کرتی ہے اور مخلصانہ بندگی، عمدہ اخلاق اور مفید معاشرتی کردار کی طرف رہنمائی کرتی ہے۔",
      ...
      libraryCaptionTitle: "الْإِخْلَاص اسلامک انسٹیٹیوٹ",
    ...
    learning: {
      ...
      pageTitle: "الْإِخْلَاص اسلامک انسٹیٹیوٹ میں تعلیم و تدریس",
      ...
      mainText1: "الْإِخْلَاص اسلامک انسٹیٹیوٹ میں ہم اپنے طلبہ کے لیے نفع بخش علم اور روحانی تربیت کو آسان بنانے کے لیے پُرعزم ہیں۔ ہم ایسے ماحول کی فراہمی پر یقین رکھتے ہیں جو حقیقی فہم، غور و فکر اور عمدہ اخلاق کو پروان چڑھائے۔",
    ...
    admission: {
      ...
      pageSubtitle: "الْإِخْلَاص اسلامک انسٹیٹیوٹ لاہور کے ساتھ نفع بخش اسلامی تعلیم کے مبارک سفر کا آغاز کیجیے۔ نیچے دیا گیا فارم پُر فرمائیں۔",
      ...
      successDesc: "جزاکم اللہ خیراً۔ آپ کا داخلہ فارم الْإِخْلَاص اسلامک انسٹیٹیوٹ لاہور کے پاس موصول ہو چکا ہے۔",
    ...
    contact: {
      ...
      pageTitle: "الْإِخْلَاص اسلامک انسٹیٹیوٹ سے رابطہ کیجیے",
      ...
      successDesc: "الْإِخْلَاص اسلامک انسٹیٹیوٹ سے رابطہ کرنے کا شکریہ۔ ہم اسلامی تعلیم میں آپ کی دلچسپی کو قدر کی نگاہ سے دیکھتے ہیں اور جلد ہی آپ کے سوال کا جواب دیں گے۔",
    ...
    footer: {
      ...
      copyright: "© 2026 الْإِخْلَاص اسلامک انسٹیٹیوٹ۔ جملہ حقوق محفوظ ہیں۔",
